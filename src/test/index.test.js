...
test('format_view', () => {
    ...
    expect(getFormattedViews(1000)).toBe("1 N");
    expect(getFormattedViews(1001)).toBe("1 N");
    expect(getFormattedViews(1200)).toBe("1 N");
    expect(getFormattedViews(1999)).toBe("1 N");
    expect(getFormattedViews(2000)).toBe("2 N");
    expect(getFormattedViews(5500)).toBe("5 N");
    expect(getFormattedViews(9999)).toBe("9 N");
    expect(getFormattedViews(10000)).toBe("10 N");
    expect(getFormattedViews(15500)).toBe("15 N");
    expect(getFormattedViews(19900)).toBe("19 N");
    expect(getFormattedViews(200000)).toBe("200 N");
    expect(getFormattedViews(1999999)).toBe("1 Tr");
    expect(getFormattedViews(3400304)).toBe("3 Tr");
    expect(getFormattedViews(45030304)).toBe("45 Tr");
    expect(getFormattedViews(1573030304)).toBe("157 Tr");
    expect(getFormattedViews(1573030304)).toBe("157 Tr");
    expect(getFormattedViews(999999999)).toBe("999 Tr");
  });
  ...
  test('format_date', () => {
    expect(getFormattedDate("2018-12-12T07:28:45.167Z")).toBe("12/12/2018");
    ...
    expect(getFormattedDate("2020-07-19T07:28:45.167Z")).toBe("19/07/2020");
    expect(getFormattedDate("2020-08-19T07:28:45.167Z")).toBe("19/08/2020");
    expect(getFormattedDate("2020-08-19T16:28:45.167Z")).toBe("7 ngày trước");
    expect(getFormattedDate("2020-08-10T07:28:45.167Z")).toBe("10/08/2020");
    expect(getFormattedDate("2020-08-21T07:28:45.167Z")).toBe("6 ngày trước");
  });
