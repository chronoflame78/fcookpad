...
export const registerUser = (userData, history) => dispatch => {
  ...
  axios
    .post("http://178.128.83.129:3000/api/auth/signup", userData)
...
export const loginUser = (userData, history) => dispatch => {
  axios
    .post("http://178.128.83.129:3000/api/auth/login", userData)
    .then(res => {
...
export const verifyAccount = verifyToken => dispatch => {
  axios
    .post("http://178.128.83.129:3000/api/auth/verify", verifyToken)
    .then(res => {
      // Save to localStorage
// Set token to localStorage
      const { token } = res.data;
