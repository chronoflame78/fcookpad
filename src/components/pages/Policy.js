      ...
      <div>
        <div className="container policy-container">
          ...
          <div className="privacy-container">
            ...
            <div>
              <p>
                &emsp;&emsp;Under the CCPA, among other rights, California
                consumers have the right to:
              </p>
              <p>
                &emsp;&emsp;Request that a business that collects a consumer's
                personal data disclose the categories and specific pieces of
                personal data that a business has collected about consumers.
              </p>
              <p>
                &emsp;&emsp;Request that a business delete any personal data
                about the consumer that a business has collected.
              </p>
              <p>
                &emsp;&emsp;Request that a business that sells a consumer's
                personal data, not sell the consumer's personal data.
              </p>
              <p>
                &emsp;&emsp;If you make a request, we have one month to respond
          ...
          <div className="gdpr-container">
            ...
            <div>
              <p>
                &emsp;&emsp;We would like to make sure you are fully aware of
                all of your data protection rights. Every user is entitled to
                the following:
              </p>
              <p>
                &emsp;&emsp;The right to access – You have the right to request
                copies of your personal data. We may charge you a small fee for
                this service.
              </p>
              <p>
                &emsp;&emsp;The right to rectification – You have the right to
              ...
              <p>
                &emsp;&emsp;The right to erasure – You have the right to request
                that we erase your personal data, under certain conditions.
              </p>
              <p>
                &emsp;&emsp;The right to restrict processing – You have the
                right to request that we restrict the processing of your
                personal data, under certain conditions.
              </p>
              <p>
                &emsp;&emsp;The right to object to processing – You have the
                right to object to our processing of your personal data, under
                certain conditions.
              </p>
              <p>
                &emsp;&emsp;The right to data portability – You have the right
